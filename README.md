...
<p align="center">
  <b style="font-size:22px; color:#FFD700;">Hi, I'm Arshia Ghotbinejad</b>
</p>

<br>

<p align="center">
  <samp style="font-size:17px;">
    🚀 Full-Stack & AI Developer from <b>Iran 🇮🇷</b> &nbsp;|&nbsp; 16 years old
  </samp>
  <br><br>
  <samp style="font-size:16px;">
    🎓 CS50x & CS50 AI student at <b>Harvard University</b>
  </samp>
  <br><br>
  <samp style="font-size:16px;">
    🏆 RoboCup competitor &nbsp;|&nbsp; 🚁 Drone & Computer Vision enthusiast
  </samp>
  <br><br>
  <samp style="font-size:18px; color:#00FF88;">
...
<p align="center">
  <samp>
    💬 Ask me about: <b>Django, FastAPI, OpenCV, YOLO</b>
  </samp>
  <br>
  <samp>
    🌱 Currently learning: <b>System Design & Advanced Computer Vision</b>
  </samp>
  <br>
  <samp>
    🎯 2026 Goals: <b>Contributing to open-source AI projects</b>
  </samp>
</p>
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=arshia54&show_icons=true&theme=radical&hide_border=true&count_private=true&bg_color=0D1117&title_color=FFD700&icon_color=00FF88&text_color=FFFFFF&include_all_commits=true" width="48%" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=arshia54&layout=compact&theme=radical&hide_border=true&bg_color=0D1117&title_color=FFD700&text_color=FFFFFF&langs_count=6" width="48%" />
</p>
...
<p align="center">
  <table border="0" cellpadding="15">
    <tr>
      <td align="center" width="280" style="border: 2px solid #FFD700; border-radius: 16px; background: rgba(255,215,0,0.04);">
        <span style="font-size: 48px;">🥇</span><br>
        <b style="color:#FFD700; font-size: 20px;">EURASIA</b><br>
        <samp style="color:#00FF88; font-size: 16px;">1st Place</samp><br>
        <samp style="color:#888; font-size: 12px;">2024 · Turkey</samp>
      </td>
      <td align="center" width="280" style="border: 2px solid #C0C0C0; border-radius: 16px; background: rgba(192,192,192,0.04);">
        <span style="font-size: 48px;">🥉</span><br>
        <b style="color:#C0C0C0; font-size: 20px;">CANADA</b><br>
        <samp style="color:#00FF88; font-size: 16px;">3rd Place</samp><br>
        <samp style="color:#888; font-size: 12px;">2024 · Canada</samp>
      </td>
      <td align="center" width="280" style="border: 2px solid #CD7F32; border-radius: 16px; background: rgba(205,127,50,0.04);">
        <span style="font-size: 48px;">🏅</span><br>
        <b style="color:#CD7F32; font-size: 20px;">IRAN OPEN</b><br>
        <samp style="color:#00FF88; font-size: 16px;">5th Place</samp><br>
        <samp style="color:#888; font-size: 12px;">2025 · Iran</samp>
      </td>
    </tr>
  </table>
</p>
...
<p align="center">
  <table border="0" cellpadding="16">
    <tr>
      <td align="center" width="300" style="border: 2px solid #4FC3F7; border-radius: 16px; background: rgba(79,195,247,0.04);">
        <span style="font-size: 54px;">🏛️</span><br>
        <b style="color:#4FC3F7; font-size: 22px;">CS50x</b><br>
        <samp style="color:#00FF88; font-size: 16px;">Harvard University</samp><br>
        <samp style="color:#888; font-size: 13px;">Computer Science</samp>
      </td>
      <td align="center" width="300" style="border: 2px solid #FF6B6B; border-radius: 16px; background: rgba(255,107,107,0.04);">
        <span style="font-size: 54px;">🧠</span><br>
        <b style="color:#FF6B6B; font-size: 22px;">CS50 AI</b><br>
        <samp style="color:#00FF88; font-size: 16px;">Harvard University</samp><br>
        <samp style="color:#888; font-size: 13px;">Artificial Intelligence</samp>
      </td>
    </tr>
  </table>
</p>
...
<p align="center">
  <table border="0" cellpadding="16">
    <tr>
      <td align="center" width="280" style="border: 2px solid #00FF88; border-radius: 16px; background: rgba(0,255,136,0.04);">
        <span style="font-size: 46px;">🚁</span><br>
        <b style="color:#00FF88; font-size: 18px;">Tello Gate Mission</b><br>
        <samp style="color:#888; font-size: 12px;">Python · OpenCV · DJI Tello</samp><br>
        <samp style="color:#aaa; font-size: 11px;">Autonomous drone navigation</samp>
      </td>
      <td align="center" width="280" style="border: 2px solid #FFD700; border-radius: 16px; background: rgba(255,215,0,0.04);">
        <span style="font-size: 46px;">🏡</span><br>
        <b style="color:#FFD700; font-size: 18px;">Web Systems</b><br>
        <samp style="color:#888; font-size: 12px;">Django · FastAPI · Java</samp><br>
        <samp style="color:#aaa; font-size: 11px;">High-performance web apps</samp>
      </td>
      <td align="center" width="280" style="border: 2px solid #FF6B6B; border-radius: 16px; background: rgba(255,107,107,0.04);">
        <span style="font-size: 46px;">👁️</span><br>
        <b style="color:#FF6B6B; font-size: 18px;">Vision System</b><br>
        <samp style="color:#888; font-size: 12px;">YOLO · TensorFlow · OpenCV</samp><br>
        <samp style="color:#aaa; font-size: 11px;">Real-time object detection</samp>
      </td>
    </tr>
  </table>
</p>
...
<p align="center">
  <samp style="font-size:18px; color:#FFD700;">
    "Any fool can write code that a computer can understand. Good programmers write code that humans can understand."
  </samp>
  <br>
  <samp style="font-size:14px; color:#888;">— Martin Fowler</samp>
</p>
...
<p align="center">
  ...
  <a href="https://www.buymeacoffee.com/arshia54">
    <img src="https://img.shields.io/badge/Buy_Me_A_Coffee-FFDD00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black&labelColor=0D1117" height="46" />
  </a>
</p>
...
<p align="center">
  <samp style="font-size:14px; color:#888;">
    <img src="https://komarev.com/ghpvc/?username=arshia54&color=00FF88&style=flat-square" />
    &nbsp; — &nbsp;
...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=18&duration=3000&pause=1500&color=FFD700&center=true&vCenter=true&width=550&lines=Thanks+for+visiting!+%F0%9F%92%9B;Star+%E2%AD%90+if+you+like+my+work!;Let's+build+something+amazing!+%F0%9F%9A%80" />
</p>

<br>

<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,3,10,15&height=140&section=footer&animation=fadeIn" width="100%"/>
</p>
